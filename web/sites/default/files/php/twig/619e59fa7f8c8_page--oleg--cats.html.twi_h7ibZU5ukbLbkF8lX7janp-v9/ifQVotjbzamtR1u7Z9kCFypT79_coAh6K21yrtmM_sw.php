...
/* themes/custom/olegtheme/templates/system/page--oleg--cats.html.twig */
class __TwigTemplate_f1cd972f2c1386a7e14e1a323c455ca41dd35e1fe65ba63024883b4cd1b52270 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["theme"] ?? null), "settings", [], "any", false, false, true, 62), "navbar_position", [], "any", false, false, true, 62)) ? (("navbar-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["theme"] ?? null), "settings", [], "any", false, false, true, 62), "navbar_position", [], "any", false, false, true, 62), 62, $this->source)))) : (""))];
        // line 65
        echo "    <header";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["navbar_attributes"] ?? null), "addClass", [0 => ($context["navbar_classes"] ?? null), 1 => "header"], "method", false, false, true, 65), 65, $this->source), "html", null, true);
...
";
  ...
  ";
    ...
    {
        return "themes/custom/olegtheme/templates/system/page--oleg--cats.html.twig";
    }
...
{% if page.footer %}
  ...
  {% endblock %}
{% endif %}
", "themes/custom/olegtheme/templates/system/page--oleg--cats.html.twig", "/var/www/web/themes/custom/olegtheme/templates/system/page--oleg--cats.html.twig");
    }
